...
const MESConfig = {
    // Override via <meta name="mpms-api-base" content="http://127.0.0.1:8000/api/v1"> if needed
    apiBaseUrl: document.querySelector('meta[name="mpms-api-base"]')?.content || "/api/v1",
    useMockData: false,
